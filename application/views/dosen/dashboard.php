        ...
        <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card o-hidden welcome-card">
                            <div class="card-body">
                                <h4 class="mb-3 mt-1 f-w-500 mb-0 f-22">Hello Walter<span> <img src="<?= base_url('/assets'); ?>/images/dashboard-3/hand.svg" alt="hand vector"></span></h4>
                                <p>Learn something new every day with world's best courses.Free online courses available.</p>
                            </div><img class="welcome-img" src="<?= base_url('/assets'); ?>/images/dashboard-3/widget.svg" alt="search image">
                        </div>
                    </div>
                    <div class="col-sm-6">
            ...
            <div class="col-xl-2 col-ed-3 d-xxl-block d-sm-none box-col-none">
                <div class="card get-card overflow-hidden">
                    <div class="card-header card-no-border">
                        <h5>Do You Want to Get</h5><span class="f-14 f-w-500 f-light">Better Results?</span><a class="btn btn-primary btn-hover-effect" href="course-details.html">More Details<span class="ms-1">
                                <svg class="fill-icon">
                                    <use href="<?= base_url('/assets'); ?>/svg/icon-sprite.svg#arrowright"></use>
                                </svg></span></a>
                    </div>
                    <div class="card-body pt-0">
                        <div class="get-image text-center"> <img class="img-fluid" src="<?= base_url('/assets'); ?>/images/dashboard-3/better.png" alt="laptop with men vector"></div>
                    </div>
                </div>
            </div>
                            ...
                            <table class="table" id="t-top-mentor">
                                ...
                                <tbody>
                                    <tr>
                                        <td></td>
                                        <td>
                                            <div class="common-flex align-items-center"><img class="img-fluid rounded-circle" src="<?= base_url('/assets'); ?>/images/dashboard/user/6.jpg" alt="user"><a class="f-w-500" href="course-list-view.html">Kathrin Ney</a></div>
                                        </td>
                                        <td>Data Science</td>
                                        <td>550</td>
                                        <td>10 Year</td>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <div class="common-flex align-items-center"><img class="img-fluid rounded-circle" src="<?= base_url('/assets'); ?>/images/dashboard/user/3.jpg" alt="user"><a class="f-w-500" href="course-list-view.html">Mili Pais</a></div>
                                        </td>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <div class="common-flex align-items-center"><img class="img-fluid rounded-circle" src="<?= base_url('/assets'); ?>/images/dashboard/user/4.jpg" alt="user"><a class="f-w-500" href="course-list-view.html">Robert Fox</a></div>
                                        </td>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <div class="common-flex align-items-center"><img class="img-fluid rounded-circle" src="<?= base_url('/assets'); ?>/images/dashboard/user/2.jpg" alt="user"><a class="f-w-500" href="course-list-view.html">Caleb Riv</a></div>
                                        </td>
                                        <td>Web Designer</td>
                                        <td>110</td>
                                        <td>12 Year</td>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <div class="common-flex align-items-center"><img class="img-fluid rounded-circle" src="<?= base_url('/assets'); ?>/images/dashboard/user/1.jpg" alt="user"><a class="f-w-500" href="course-list-view.html">Caryl Kauth</a></div>
                                        </td>
                                        <td>JS Developer</td>
                                        <td>120</td>
                                        <td>10 Year</td>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <div class="common-flex align-items-center"><img class="img-fluid rounded-circle" src="<?= base_url('/assets'); ?>/images/dashboard/user/5.jpg" alt="user"><a class="f-w-500" href="course-list-view.html">Eriko Fonsa</a></div>
                                        </td>
                                        <td>Painter</td>
                                        <td>360</td>
                                        <td>06 Year</td>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <div class="common-flex align-items-center"><img class="img-fluid rounded-circle" src="<?= base_url('/assets'); ?>/images/dashboard/user/13.jpg" alt="user"><a class="f-w-500" href="course-list-view.html">Olivia Gor</a></div>
                                        </td>
                                        <td>Mathematics</td>
                                        <td>221</td>
                                        <td>08 Year</td>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <div class="common-flex align-items-center"><img class="img-fluid rounded-circle" src="<?= base_url('/assets'); ?>/images/dashboard/user/10.jpg" alt="user"><a class="f-w-500" href="course-list-view.html">Emily Park</a></div>
                                        </td>
                                        <td>Painter</td>
                                        <td>859</td>
                                        <td>03 Year</td>
                            ...
                            <table class="table" id="completed-course-table">
                                ...
                                <tbody>
                                    <tr>
                                        <td></td>
                                        <td>
                                            <div class="common-flex align-items-center"><img class="img-fluid" src="<?= base_url('/assets'); ?>/images/dashboard/user/7.jpg" alt="user"><a class="f-w-500" href="course-details.html">Cody Fisher</a></div>
                                        </td>
                                        <td>Python</td>
                                        <td>Oct 25, 2024</td>
                                        <td>Wade Warren</td>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <div class="common-flex align-items-center"><img class="img-fluid" src="<?= base_url('/assets'); ?>/images/dashboard/user/12.jpg" alt="user"><a class="f-w-500" href="course-details.html">Alexis Taylor</a></div>
                                        </td>
                                        <td>Analysis</td>
                                        <td>May 20, 2024</td>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <div class="common-flex align-items-center"><img class="img-fluid" src="<?= base_url('/assets'); ?>/images/user/10.jpg" alt="user"><a class="f-w-500" href="course-details.html">Jenny Wilson</a></div>
                                        </td>
                                        <td>Development</td>
                                        <td>Apr 28, 2024</td>
                                        <td>Guy Hawkins</td>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <div class="common-flex align-items-center"><img class="img-fluid" src="<?= base_url('/assets'); ?>/images/dashboard/user/2.jpg" alt="user"><a class="f-w-500" href="course-details.html">Lily Ramirez</a></div>
                                        </td>
                                        <td>Marketing</td>
                                        <td>Mar 13, 2024</td>
                                        <td>Ethan Brooks</td>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <div class="common-flex align-items-center"><img class="img-fluid" src="<?= base_url('/assets'); ?>/images/dashboard/user/11.jpg" alt="user"><a class="f-w-500" href="course-details.html">Andrew Price</a></div>
                                        </td>
                                        <td>Developer</td>
                                        <td>Feb 12, 2024</td>
                                        <td>Nathan Cooper</td>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <div class="common-flex align-items-center"><img class="img-fluid" src="<?= base_url('/assets'); ?>/images/user/6.jpg" alt="user"><a class="f-w-500" href="course-details.html">Luke Mitchell</a></div>
                                        </td>
                                        <td>Mathematics</td>
                                        <td>Apr 12, 2024</td>
                                        <td>Owen Davis</td>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <div class="common-flex align-items-center"><img class="img-fluid" src="<?= base_url('/assets'); ?>/images/user/3.png" alt="user"><a class="f-w-500" href="course-details.html">Caleb Rivera</a></div>
                                        </td>
                                        <td>Architect</td>
                                        <td>May 09, 2024</td>
                                        <td>Zoey Jenkins</td>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <div class="common-flex align-items-center"><img class="img-fluid" src="<?= base_url('/assets'); ?>/images/user/14.png" alt="user"><a class="f-w-500" href="course-details.html">Chloe Wilson</a></div>
                                        </td>
                                        <td>Writer</td>
                                        <td>May 04, 2024</td>
                                        <td>Alexis Taylor</td>
                        ...
                        <div class="course-main-card">
                            <div class="course-wrapper">
                                <div class="course-icon-box">
                                    <div class="icon-wrap"><img src="<?= base_url('/assets'); ?>/images/dashboard-3/course/1.svg" alt="clock vector"></div><img class="arrow-bg" src="<?= base_url('/assets'); ?>/images/dashboard-3/course/back-arrow/1.png" alt="sqaure border arrow">
                                </div>
                                <h6 class="f-14">Management</h6>
                            </div>
                            <div class="course-wrapper">
                                <div class="course-icon-box">
                                    <div class="icon-wrap"><img src="<?= base_url('/assets'); ?>/images/dashboard-3/course/2.svg" alt="web development vector"></div><img class="arrow-bg" src="<?= base_url('/assets'); ?>/images/dashboard-3/course/back-arrow/2.png" alt="sqaure border arrow">
                                </div>
                                <h6 class="f-14">Web Devlopment</h6>
                            </div>
                            <div class="course-wrapper">
                                <div class="course-icon-box">
                                    <div class="icon-wrap"><img src="<?= base_url('/assets'); ?>/images/dashboard-3/course/3.svg" alt="business vector"></div><img class="arrow-bg" src="<?= base_url('/assets'); ?>/images/dashboard-3/course/back-arrow/1.png" alt="sqaure border arrow">
                                </div>
                                <h6 class="f-14">Business Analytics</h6>
                            </div>
                            <div class="course-wrapper">
                                <div class="course-icon-box">
                                    <div class="icon-wrap"><img src="<?= base_url('/assets'); ?>/images/dashboard-3/course/4.svg" alt="marketing vector"></div><img class="arrow-bg" src="<?= base_url('/assets'); ?>/images/dashboard-3/course/back-arrow/3.png" alt="sqaure border arrow">
                                </div>
                ...
                <div class="card schedule-card">
                    ...
                    <div class="card-body pt-0">
                        <ul class="schedule-list">
                            <li class="primary"><img src="<?= base_url('/assets'); ?>/images/dashboard/user/4.jpg" alt="profile">
                                <div>
                                    <h6 class="mb-1">Web Design</h6>
                                    <ul>
                                        <li class="f-light">
                                            <svg class="fill-icon f-light">
                                                <use href="<?= base_url('/assets'); ?>/svg/icon-sprite.svg#bag"></use>
                                            </svg><span>March 3, 2024</span>
                                        </li>
                                        <li class="f-light">
                                            <svg class="fill-icon f-success">
                                                <use href="<?= base_url('/assets'); ?>/svg/icon-sprite.svg#clock"></use>
                                            </svg><span> 09.00 - 12.00 AM</span>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li class="warning"><img src="<?= base_url('/assets'); ?>/images/dashboard/user/2.jpg" alt="profile">
                                <div>
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <ul class="lessons-lists">
                            <li> <img src="<?= base_url('/assets'); ?>/images/dashboard-3/lessons/1.png" alt="ux icon">
                                <div>
                            ...
                            <li> <img src="<?= base_url('/assets'); ?>/images/dashboard-3/lessons/2.png" alt="vue icon">
                                <div>
                            ...
                            <li> <img src="<?= base_url('/assets'); ?>/images/dashboard-3/lessons/3.png" alt="bootstrap icon">
                                <div>

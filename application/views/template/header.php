...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url('/assets'); ?>/css/vendors/jquery.dataTables.css">
    <link rel="stylesheet" type="text/css" href="<?= base_url('/assets'); ?>/css/vendors/select.bootstrap5.css">

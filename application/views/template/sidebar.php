...
<div class="page-body-wrapper">
    ...
    <div class="sidebar-wrapper" data-sidebar-layout="stroke-svg">
        <div>
            <div class="logo-wrapper"><a href="index.html"><img class="img-fluid for-light" src="<?= base_url('/assets'); ?>/images/logo/logo1.png" alt=""><img class="img-fluid for-dark" src="<?= base_url('/assets'); ?>/images/logo/logo_dark.png" alt=""></a>
                    ...
                    <ul class="sidebar-links" id="simple-bar">
                        ...
                        <li class="sidebar-list">
                            <label class="badge badge-light-success">New</label><i class="fa-solid fa-thumbtack"></i><a class="sidebar-link sidebar-title" href="#">
                                <svg class="stroke-icon">
                                    <use href="<?= base_url('/assets'); ?>/svg/icon-sprite.svg#stroke-reports"></use>
                                </svg>
                                <svg class="fill-icon">
                                    <use href="<?= base_url('/assets'); ?>/svg/icon-sprite.svg#fill-reports"></use>
